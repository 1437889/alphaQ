...
public class ViewQuestion extends Activity {
    ...
    public void updateVote(View v){
        ...
        @SuppressLint("StaticFieldLeak") AsyncHTTPPost asyncHTTPPost = new AsyncHTTPPost("http://lamp.ms.wits.ac.za/~s1619336/updateVote.php?type=" + Integer.toString(Voted)
    ...
    public void listAnswers(int question, final Boolean clicked, final int aidclicked){
        ...
        @SuppressLint("StaticFieldLeak") AsyncHTTPPost asyncHTTPPost = new AsyncHTTPPost("http://lamp.ms.wits.ac.za/~s1619336/answerlist.php?qid="
    ...
    public void postAnswer(View v){
        ...
        builder.setPositiveButton("Post answer", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                params.put("","");
                Bundle extras = getIntent().getExtras();
                @SuppressLint("StaticFieldLeak") AsyncHTTPPost asyncHTTPPost = new AsyncHTTPPost("http://lamp.ms.wits.ac.za/~s1619336/newAnswer.php?username="
